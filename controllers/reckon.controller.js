...
const reckonRegistration = async (req, res) => {
    ...
    try {
        const team = new Reckon({leaderName, leaderEmail, leaderPhone, teamName, member2Name, member2Email, member2Phone, member3Name, member3Email, member3Phone, member4Name, member4Email, member4Phone});
